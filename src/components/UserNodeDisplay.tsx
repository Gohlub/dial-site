    ...
    return (
        <div
            className={classNames(
                'flex flex-col items-center self-stretch rounded rounded-md p-2',
                {
        ...
        >
            <a
                ...
                className="mb-2"
            >
                <h3 className="grow p-3 cursor-pointer hover:bg-white/35 rounded bg-green/25">
                    {node.kinode_name}.os
                </h3>
            </a>
            <div className="flex c">
                <button className="icon" onClick={() => setActiveNode(node)}>
                    <FaGear />
                </button>
            </div>
        </div>
